...
rm -rf ${rootdir}/${system}/013.denovo_rescore/${vendor}/fps_vdw_rank
mkdir -p ${rootdir}/${system}/013.denovo_rescore/${vendor}/fps_vdw_rank
cd ${rootdir}/${system}/013.denovo_rescore/${vendor}/fps_vdw_rank
...
##################################################
cat <<EOF >${system}.denovo.fps_vdw_rank_score.in
...
descriptor_fps_score_es_fp_scale                             0
...
ligand_outfile_prefix                                        denovo.fps_vdw.output
write_footprints                                             no
write_hbonds                                                 no
...
cat <<EOF >${system}.denovo.fps_vdw_rank.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${system}.dn.fps_vdw_rank
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6.mpi -v \
-i ${system}.denovo.fps_vdw_rank_score.in \
-o ${system}.denovo.fps_vdw_rank_score.out
...
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=24
#SBATCH --job-name=${system}.dn.fps_vdw_rank
#SBATCH --output=${system}.dn.fps_vdw_rank
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.denovo.fps_vdw_rank.qsub.csh"
qsub ${system}.denovo.fps_vdw_rank.qsub.csh > & ${system}.denovo.fps_vdw_rank.qsub.log
date
