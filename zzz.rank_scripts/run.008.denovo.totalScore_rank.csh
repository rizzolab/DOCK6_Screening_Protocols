...
rm -rf ${rootdir}/${system}/013.denovo_rescore/${vendor}/totalScore_rank
mkdir -p ${rootdir}/${system}/013.denovo_rescore/${vendor}/totalScore_rank
cd ${rootdir}/${system}/013.denovo_rescore/${vendor}/totalScore_rank
...
##################################################
cat <<EOF >${system}.denovo.totalScore_rank_score.in
...
ligand_outfile_prefix                                        denovo.totalScore.output
write_footprints                                             no
write_hbonds                                                 no
...
cat <<EOF >${system}.denovo.totalScore_rank.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${system}.dn.totalScore_rank
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6.mpi -v \
-i ${system}.denovo.totalScore_rank_score.in \
-o ${system}.denovo.totalScore_rank_score.out
...
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=24
#SBATCH --job-name=${system}.dn.totalScore_rank
#SBATCH --output=${system}.dn.totalScore_rank
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.denovo.totalScore_rank.qsub.csh"
qsub ${system}.denovo.totalScore_rank.qsub.csh > & ${system}.denovo.totalScore_rank.qsub.log
date
