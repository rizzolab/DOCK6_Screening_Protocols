...
rm -rf ${rootdir}/${system}/013.denovo_rescore/${vendor}/fms_score_rank
mkdir -p ${rootdir}/${system}/013.denovo_rescore/${vendor}/fms_score_rank
cd ${rootdir}/${system}/013.denovo_rescore/${vendor}/fms_score_rank
...
##################################################
cat <<EOF >${system}.denovo.fms_score_rank_score.in
...
ligand_outfile_prefix                                        denovo.fms_score.output
...
cat <<EOF >${system}.denovo.fms_score_rank.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${system}.dn.fms_score_rank
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6.mpi -v \
-i ${system}.denovo.fms_score_rank_score.in \
-o ${system}.denovo.fms_score_rank_score.out
...
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=24
#SBATCH --job-name=${system}.dn.fms_score_rank
#SBATCH --output=${system}.dn.fms_score_rank
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.denovo.fms_score_rank.qsub.csh"
qsub ${system}.denovo.fms_score_rank.qsub.csh > & ${system}.denovo.fms_score_rank.qsub.log
date
