...
rm -rf ${rootdir}/${system}/013.denovo_rescore/${vendor}/descriptor_score_rank
mkdir -p ${rootdir}/${system}/013.denovo_rescore/${vendor}/descriptor_score_rank
cd ${rootdir}/${system}/013.denovo_rescore/${vendor}/descriptor_score_rank
...
##################################################
cat <<EOF >${system}.denovo.descriptor_score_rank_score.in
...
ligand_outfile_prefix                                        denovo.descriptor_score.output
write_footprints                                             no
write_hbonds                                                 no
...
cat <<EOF >${system}.denovo.descriptor_score_rank.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${system}.dn.descriptor_score_rank
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6.mpi -v \
-i ${system}.denovo.descriptor_score_rank_score.in \
-o ${system}.denovo.descriptor_score_rank_score.out
...
##################################################
###if (`hostname -f` == "rizzo.cm.cluster" || `hostname -f` == "login2.cm.cluster" ) then
else
cat <<EOF >${system}.denovo.descriptor_score_rank.qsub.csh
#!/bin/tcsh
#SBATCH --time=${wcl}
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=24
#SBATCH --job-name=${system}.dn.descriptor_score_rank
#SBATCH --output=${system}.dn.descriptor_score_rank
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.denovo.descriptor_score_rank.qsub.csh"
qsub ${system}.denovo.descriptor_score_rank.qsub.csh > & ${system}.denovo.descriptor_score_rank.qsub.log
date
