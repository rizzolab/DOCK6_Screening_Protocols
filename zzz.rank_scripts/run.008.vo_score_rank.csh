...
rm -rf ${rootdir}/${system}/008.rank_mol/${vendor}/vo_score_rank
mkdir -p ${rootdir}/${system}/008.rank_mol/${vendor}/vo_score_rank
cd ${rootdir}/${system}/008.rank_mol/${vendor}/vo_score_rank
...
##################################################
cat <<EOF >${system}.${vendor}.vo_score_rank_score.in
...
ligand_outfile_prefix                                        ${vendor}.vo_score.output
...
cat <<EOF >${system}.${vendor}.vo_score_rank.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${system}.vs.vo_score_rank
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6.mpi -v \
-i ${system}.${vendor}.vo_score_rank_score.in \
-o ${system}.${vendor}.vo_score_rank_score.out
...
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=24
#SBATCH --job-name=${system}.vs.vo_score_rank
#SBATCH --output=${system}.vs.vo_score_rank
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.${vendor}.vo_score_rank.qsub.csh"
qsub ${system}.${vendor}.vo_score_rank.qsub.csh > & ${system}.${vendor}.vo_score_rank.qsub.log
date
