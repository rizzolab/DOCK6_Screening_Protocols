...
rm -rf ${rootdir}/${system}/013.denovo_rescore/${vendor}/hms_score_rank
mkdir -p ${rootdir}/${system}/013.denovo_rescore/${vendor}/hms_score_rank
cd ${rootdir}/${system}/013.denovo_rescore/${vendor}/hms_score_rank
...
##################################################
cat <<EOF >${system}.denovo.hms_score_rank_score.in
...
ligand_outfile_prefix                                        denovo.hms_score.output
...
cat <<EOF >${system}.denovo.hms_score_rank.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${system}.dn.hms_score_rank
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6.mpi -v \
-i ${system}.denovo.hms_score_rank_score.in \
-o ${system}.denovo.hms_score_rank_score.out
...
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=24
#SBATCH --job-name=${system}.dn.hms_score_rank
#SBATCH --output=${system}.dn.hms_score_rank
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.denovo.hms_score_rank.qsub.csh"
qsub ${system}.denovo.hms_score_rank.qsub.csh > & ${system}.denovo.hms_score_rank.qsub.log
date
