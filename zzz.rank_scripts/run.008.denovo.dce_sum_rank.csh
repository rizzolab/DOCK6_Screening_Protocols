...
rm -rf ${rootdir}/${system}/013.denovo_rescore/${vendor}/dce_sum_rank
mkdir -p ${rootdir}/${system}/013.denovo_rescore/${vendor}/dce_sum_rank
cd ${rootdir}/${system}/013.denovo_rescore/${vendor}/dce_sum_rank
...
##################################################
cat <<EOF >${system}.denovo.dce_sum_rank_score.in
...
ligand_outfile_prefix                                        denovo.dce_sum.output
...
cat <<EOF >${system}.denovo.dce_sum_rank.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${system}.dn.dce_sum_rank
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6.mpi -v \
-i ${system}.denovo.dce_sum_rank_score.in \
-o ${system}.denovo.dce_sum_rank_score.out
...
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=24
#SBATCH --job-name=${system}.dn.dce_sum_rank
#SBATCH --output=${system}.dn.dce_sum_rank
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.denovo.dce_sum_rank.qsub.csh"
qsub ${system}.denovo.dce_sum_rank.qsub.csh > & ${system}.denovo.dce_sum_rank.qsub.log
date
