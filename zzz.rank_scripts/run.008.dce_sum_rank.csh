...
rm -rf ${rootdir}/${system}/008.rank_mol/${vendor}/dce_sum_rank
mkdir -p ${rootdir}/${system}/008.rank_mol/${vendor}/dce_sum_rank
cd ${rootdir}/${system}/008.rank_mol/${vendor}/dce_sum_rank
...
##################################################
cat <<EOF >${system}.${vendor}.dce_sum_rank_score.in
...
ligand_outfile_prefix                                        ${vendor}.dce_sum.output
...
cat <<EOF >${system}.${vendor}.dce_sum_rank.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${system}.vs.dce_sum_rank
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6.mpi -v \
-i ${system}.${vendor}.dce_sum_rank_score.in \
-o ${system}.${vendor}.dce_sum_rank_score.out
...
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=24
#SBATCH --job-name=${system}.vs.dce_sum_rank
#SBATCH --output=${system}.vs.dce_sum_rank
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.${vendor}.dce_sum_rank.qsub.csh"
qsub ${system}.${vendor}.dce_sum_rank.qsub.csh > & ${system}.${vendor}.dce_sum_rank.qsub.log
date
