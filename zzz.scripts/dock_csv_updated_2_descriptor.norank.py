...
## This script no longer prunes molecules - that occurs at the 008 step in the ranking scripts. All molecules are passed into moe. 
...
def read_dock_fp_out(file, max_num):
    ...
    for line in file1:
         ...
         if (len(linesplit) > 2):
             ...
             if (linesplit[1] == "DOCK_Rotatable_Bonds:"):
