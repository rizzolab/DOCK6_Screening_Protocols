...
###  name_dock,vdw,es,int_energy,hbond,vdw_fp,es_fp,hb_fp,totalScore,vdw_fp_numres,es_fp_numres,hb_fp_numres,rot_bond
###  ZINC05935212,-32.205696,-0.606634,126.884537,0,4.105981,5.769107,2.44949,-32.812328,118,118,118,3
...
class LIG_DATA:
    def __init__(self, name_dock, name_moe, cluster, clustersize, totalScore, dce_sum, dce_vdw, dce_es, int_energy, fps_sum, fps_vdw, fps_es, fps_hb, vdw_fp_numres, es_fp_numres, hb_fp_numres, hbond, rot_bond, weight, b_rotN, chiral, lip_don, lip_acc, lip_druglike, lip_violation, SlogP, FCharge, logS, lig_eff, smiles):
...
def print_LIG_DATA(data):
    print str(data.name_dock) + "," + str(data.name_moe) + "," + str(data.cluster) + "," + str(data.clustersize) + "," + str(data.totalScore) + "," + str(data.dce_sum) + "," + str(data.dce_vdw) + "," + str(data.dce_es) + "," + str(data.int_energy) + "," + str(data.fps_sum) + "," + str(data.fps_vdw) + "," + str(data.fps_es) + "," + str(data.fps_hb) + "," + str(data.vdw_fp_numres) + "," + str(data.es_fp_numres) + "," + str(data.hb_fp_numres) + "," + str(data.hbond) + "," + str(data.rot_bond) + "," + str(data.weight) + "," + str(data.b_rotN) + "," + str(data.chiral) + "," + str(data.lip_don) + "," + str(data.lip_acc) + "," + str(data.lip_druglike) + "," + str(data.lip_violation) + "," + str(data.SlogP) + "," + str(data.FCharge) + "," + str(data.logS) + "," + str(data.lig_eff) + "," + str(data.smiles)
...
def write_csv(data,filename):
    ...
    filehandle.write("name_dock,name_moe,cluster,clustersize,totalScore(fps+dce),dce_sum(vdw+es),dce_vdw,dce_es,int_energy,fps_sum(vdw+es),fps_vdw,fps_es,fps_hb,vdw_fp_numres,es_fp_numres,hb_fp_numres,hbond,rot_bond,weight,b_rotN,chiral,lip_don,lip_acc,lip_druglike,lip_violation,SlogP,FCharge,logS,lig_eff,smiles\n")
...
###  name_dock,vdw,es,int_energy,hbond,vdw_fp,es_fp,hb_fp,totalScore,vdw_fp_numres,es_fp_numres,hb_fp_numres,rot_bond
###  ZINC05935212,-32.205696,-0.606634,126.884537,0,4.105981,5.769107,2.44949,-32.812328,118,118,118,1
### MOE csv contains the following:
