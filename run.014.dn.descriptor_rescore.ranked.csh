...
### the same vendor.
if (! -e ${rootdir}/${system}/014.denovo-desc-rescore) then
	mkdir -p ${rootdir}/${system}/014.denovo-desc-rescore/
endif

if (! -e ${rootdir}/${system}/014.denovo-desc-rescore/${vendor}) then
	mkdir -p ${rootdir}/${system}/014.denovo-desc-rescore/${vendor}
endif

foreach score (dce_sum fps_es fps_sum fps_vdw totalScore fms_score vo_score hms_score descriptor_score)
  echo ${score}

  rm -rf ${rootdir}/${system}/014.denovo-desc-rescore/${vendor}/${score}_rank
  mkdir -p ${rootdir}/${system}/014.denovo-desc-rescore/${vendor}/${score}_rank
  cd ${rootdir}/${system}/014.denovo-desc-rescore/${vendor}/${score}_rank
...
##################################################
cat <<EOF >${system}.denovo.${score}.descriptor_rescore.in
conformer_search_type                                        rigid
use_internal_energy                                          yes
internal_energy_rep_exp                                      12
internal_energy_cutoff                                       100.0
ligand_atom_file                                             ${rootdir}/${system}/013.denovo_rescore/${vendor}/${score}_rank/denovo.${score}.output_ranked.mol2
...
ligand_outfile_prefix                                        denovo.${score}_rank.output
...
cat <<EOF >${system}.denovo.${score}.descriptor_rescore.qsub.csh
#!/bin/tcsh
#PBS -l walltime=${wcl}
#PBS -l nodes=${nodes}:ppn=${ppn}
#PBS -N ${score}.${system}.denovo.descriptor
#PBS -q ${queue}
#PBS -V
#PBS -j oe
...
${dockdir}/dock6 -v \
-i ${system}.denovo.${score}.descriptor_rescore.in \
-o ${system}.denovo.${score}.descriptor_rescore.out
...
#SBATCH --nodes=${nodes}
#SBATCH --ntasks=${ppn}
#SBATCH --job-name=${score}.${system}.denovo.descriptor
#SBATCH --output=${score}.${system}.denovo.descriptor
#SBATCH -p rn-long
...
### Submit the job
echo "Submitting ${system}.denovo.${score}.descriptor_rescore"
qsub ${system}.denovo.${score}.descriptor_rescore.qsub.csh > & ${system}.denovo.${score}.descriptor_rescore.qsub.log
date
